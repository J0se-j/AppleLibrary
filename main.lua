...
function lib:init(ti, dosplash, visiblekey, deleteprevious, themeName)
    ...
    -- Notification Systems (Condensed for brevity, styling uses primaryColor)
    ...
    -- [Notification darkness & text setup omitted for brevity in output, uses identical logic to your original but colors updated]
    -- NOTE: In your real environment, ensure you carry over the full notif text labels here.
    ...
    function window:Section(name)
        ...
        function sec:Switch(name, defaultmode, callback)
            ...
            -- ... [Styling logic from your original script]
